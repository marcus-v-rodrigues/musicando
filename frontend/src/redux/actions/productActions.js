...
export const listProductsCategory = ( category = '' ) => async (
  ...
  try {
    ...
    dispatch({
      type: product.PRODUCT_CATEGORY_SUCCESS,
      payload: data,
    })
  } catch (error) {
    dispatch({
      type: product.PRODUCT_CATEGORY_FAIL,
      payload:
        error.response && error.response.data.message
          ? error.response.data.message
          : error.message,
...
export const createProductReview = (productId, review) => async (
  ...
  try {
    dispatch({
      type: product.PRODUCT_CREATE_REVIEW_REQUEST,
    })
    ...
    dispatch({
      type: product.PRODUCT_CREATE_REVIEW_SUCCESS,
    })
  } catch (error) {
    const message =
      error.response && error.response.data.message
...
export const listTopProducts = () => async (dispatch) => {
  try {
    ...
    dispatch({
      type: product.PRODUCT_TOP_SUCCESS,
      payload: data,
    })
  } catch (error) {
    dispatch({
